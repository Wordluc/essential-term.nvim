...
local function open_window()
	...
	if c.bg or c.fg then
		...
		"Normal:EssentialTermNormal,NormalFloat:EssentialTermNormal,NormalNC:EssentialTermNormal"
	end
...
function M.create(name)
	...
	Set_keys_mapping(config.options.mapping, bufnr)
